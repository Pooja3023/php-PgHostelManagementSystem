...
<form action="tnth.php" method="POST">
<input type="submit" name="insert" value="INSERT"></form>
<form action="tntdh.php" method="POST">
...
<form action="tntot.php" method="POST">
<input type="submit" name="insert" value="INSERT"></form>
<form action="tntdot.php" method="POST">
<input type="submit" name="insert" value="DELETE">
</form>
...
<form action="tntmn.php" method="POST">
<input type="submit" name="insert" value="INSERT"></form>
<form action="tntdmn.php" method="POST">
<input type="submit" name="insert" value="DELETE">
</form>
